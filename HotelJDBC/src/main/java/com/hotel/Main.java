...
public class Main {
    ...
    // ===== КЛІЄНТИ =====
    static void clientMenu() throws Exception {
        ...
        switch (Integer.parseInt(scanner.nextLine())) {
            ...
            case 2 -> {
                System.out.print("ID: ");
                System.out.println(dao.read(Integer.parseInt(scanner.nextLine())));
            }
            case 3 -> {
    ...
    // ===== ТИПИ НОМЕРІВ =====
    static void roomTypeMenu() throws Exception {
    ...
    // ===== НОМЕРИ =====
    static void roomMenu() throws Exception {
    ...
    // ===== БРОНЮВАННЯ =====
    static void reservationMenu() throws Exception {
        ...
        switch (Integer.parseInt(scanner.nextLine())) {
            ...
            case 3 -> {
                ...
                System.out.print("Дата (yyyy-MM-ddTHH:mm): ");
                LocalDateTime dt = LocalDateTime.parse(scanner.nextLine());
                System.out.print("ID клієнта: ");
                int clientId = Integer.parseInt(scanner.nextLine());
                System.out.print("ID номера: ");
                int roomId = Integer.parseInt(scanner.nextLine());
                dao.create(new Reservation(0, guests, dt, clientId, roomId));
            }
            case 4 -> {
                ...
                int guests = Integer.parseInt(scanner.nextLine());
                System.out.print("Нова дата (yyyy-MM-ddTHH:mm): ");
                LocalDateTime dt = LocalDateTime.parse(scanner.nextLine());
                System.out.print("Новий ID клієнта: ");
                int clientId = Integer.parseInt(scanner.nextLine());
                System.out.print("Новий ID номера: ");
                int roomId = Integer.parseInt(scanner.nextLine());
                dao.update(new Reservation(id, guests, dt, clientId, roomId));
            }
            case 5 -> {
                System.out.print("ID для видалення: ");
                dao.delete(Integer.parseInt(scanner.nextLine()));
    ...
    // ===== ОПЛАТИ =====
    static void paymentMenu() throws Exception {
    ...
    // ===== РЕЙТИНГИ =====
    static void roomRatingMenu() throws Exception {
        ...
        switch (Integer.parseInt(scanner.nextLine())) {
            ...
            case 4 -> {
                ...
                int id = Integer.parseInt(scanner.nextLine());
                System.out.print("Новий рейтинг: ");
                float score = Float.parseFloat(scanner.nextLine());
                System.out.print("Новий ID номера: ");
                int roomId = Integer.parseInt(scanner.nextLine());
